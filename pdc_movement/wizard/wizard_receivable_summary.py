...
class ReceivableSummaryWizard(models.TransientModel):
    _name = "receivable.summary.wizard"
    ...
    def check_report(self):
        ...
        return {
            ...
            'data': {'model': 'receivable.summary.wizard',
    ...
    def get_xlsx(self, options, response=None):
        ...
        data['ids'] = []
        env_obj = vals.env['report.pdc_movement.receivable_summary_report']
        result, project_list = env_obj.get_result()
        sheet = workbook.add_worksheet()
        format1 = workbook.add_format({'font_size': 16, 'align': 'center', 'bg_color': '#DFDFDF', 'bold': True, 'text_wrap': True})
        ...
        sheet.merge_range(3, 0, 1, 3, "Receivable Summary", format1)
        ...
        project_row = 1
        sheet.write(7, project_row-1, 'Sales Value', format2)
        ...
        for list in project_list:
            sheet.write(6, project_row, list, format1)
            sheet.write(7, project_row, result[list]['Sales Value'], format7)
