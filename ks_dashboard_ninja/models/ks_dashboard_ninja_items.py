...
class KsDashboardNinjaItems(models.Model):
    ...
    ks_addtotal = fields.Boolean(default=False, string="Add Total")
    # ---------------------------- Date Filter Fields ------------------------------------------
    ...
    ks_multiplier_lines = fields.One2many('ks_dashboard_item.multiplier', 'ks_dashboard_item_id',
                                          compute='_ks_compute_multiplier_lines',
    ...
    @api.depends('ks_multiplier_active', 'ks_chart_measure_field', 'ks_list_view_group_fields')
    def _ks_compute_multiplier_lines(self):
        for rec in self:
            ...
            for ks_chart_measure_field in ks_chart_measure_fields:
                ...
                self.env['ks_dashboard_item.multiplier'].create(ks_dict)
    ...
    def get_list_view_record(self, orderid, sort_order, ks_chart_domain, ksoffset=0,
        ...
        ks_list_view_data = {'label': [], 'fields': [],'ks_addtotal':self.ks_addtotal , 'fields_type': [],
